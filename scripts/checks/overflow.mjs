...
function scan() {
  ...
  for (const e of document.querySelectorAll("body *")) {
    ...
    // data-hscroll marks the pinned sideways strip, which runs past the edge on purpose.
    if (e.closest("[aria-hidden='true'], .sr-only, [class*='marquee'], [data-hscroll]")) continue;
